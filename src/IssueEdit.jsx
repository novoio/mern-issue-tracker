    ...
    .then(response => {
      if (response.ok) {
        response.json().then(updatedIssue => {
          ...
          this.props.showSucess('Updated issue successfully.');
        });
      } else {
        ...
        <Panel.Body>
          <Form horizontal onSubmit={this.onSubmit}>
            ...
            <FormGroup>
              ...
              <Col sm={9}>
                <FormControl componentClass={NumInput} size={5} name="effort" value={issue.effort} onChange={this.onChange} />
              </Col>
            </FormGroup>
            <FormGroup validationState={this.state.invalidFields.completionDate ? 'error' : null}>
              ...
              <Col sm={9}>
                <FormControl componentClass={DateInput} name="completionDate"
