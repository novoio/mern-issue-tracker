...
app.use(session({ secret: '38eip8wzsek', resave: false, saveUninitialized: true }));

let db;

// Checks if there is a session for any API calls of DELETE, POST, PUT methods
// -------------------------------------------------
...
app.post('/signin', (req, res) => {
  ...
  const oauthUrl = 'https://www.googleapis.com/oauth2/v3/tokeninfo';
  fetch(`${oauthUrl}?id_token=${req.body.id_token}`)
  .then(response => {
